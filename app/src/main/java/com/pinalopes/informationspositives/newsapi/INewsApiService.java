...
public interface INewsApiService {
    ...
    @GET("/v2/everything?excludeDomains=fark.com,9gag.com&sortBy=publishedAt")
    Call<News> getCategoryLatestNews(@Query("language") String language, @Query("q") String q, @Query("from") String from, @Query("page") int page, @Query("apiKey") String key);
